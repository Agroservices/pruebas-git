...
public class servicesFacadeTest {
    ...
    public void testCalculoListaCompras() throws ServicesException {
        ...
        assertEquals("El cálculo de una lista de productos existentes no es correcto.",600,sf.calcularCostoListaNew(Arrays.asList(new Producto[]{p1,p2,p3})));
    ...
    public void testCalculoListaComprasInvalida()  {
        ...
        try{
            ...
            sf.calcularCostoListaNew(Arrays.asList(new Producto[]{p1,p2,p3}));
